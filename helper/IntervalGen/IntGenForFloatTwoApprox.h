...
class IntervalGenerator2 {
    ...
    bool GuessInitialLbUb(float, double, double, double,
...
void IntervalGenerator2::ComputeReducedInterval(float input,
    ...
    bool useThis = GuessInitialLbUb(input, roundingLb, roundingUb, reducedInput,
...
float IntervalGenerator2::FromMPFR(mpfr_t _mval) {
