 ...
 *     GeneratedFunctions/cr/x86/exp_double_x86.c --fname exp_double_x86
 * 
**/
#include <stdint.h>
#include <math.h>
...
static const double exp_double_x86_exp2_table[9]  = {
...
double exp_double_x86(double);
double exp_double_x86(double x){
    int oflow_test;
    double vx_floor;
    double vx_r;
    double tmp;
    ...
    hi_part_value = exp_double_x86_exp2_table[tmp2];
    vx_int = vx_floor;
    tmp3 = r_hi * 0.125;
    r_lo = vx_r - tmp3;
