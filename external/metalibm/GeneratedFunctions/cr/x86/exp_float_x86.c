 ...
 *     float --target x86 --output GeneratedFunctions/cr/x86/exp_float_x86.c \
 *     --fname exp_float_x86
 * 
**/
#include <stdint.h>
...
float exp_float_x86(float x){
    ...
    hi_part_value = exp_float_x86_exp2_table[tmp2];
    vx_int = vx_floor;
    tmp3 = r_hi * 0.125f;
    r_lo = vx_r - tmp3;
