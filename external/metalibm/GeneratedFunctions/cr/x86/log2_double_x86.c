 ...
 *     GeneratedFunctions/cr/x86/log2_double_x86.c --fname log2_double_x86
 * 
**/
#include <stdint.h>
...
double log2_double_x86(double);
double log2_double_x86(double x){
    int64_t vx_as_int;
    int64_t tmp;
    int tmp1;
    ...
    tmp19 = exponent_srl_cast >> INT64_C(52);
    tmp20 = tmp19 + INT64_C(-1023);
    tmp_eptau = tmp20 + ( (int64_t) tmp18);
    tmp21 = tmp_eptau - alpha;
    fp_exponent = tmp21;
    tmp22 = double_from_64b_encoding(ri_fast_rndn);
    carg =  - 1.0;
    u = fma(tmp7, tmp22, carg);
    tmp23 = u * 0x1.0c9dc776fcc8ap-3;
    carg1 =  - tmp23;
    tmp24 = fma(u, 0x1.0c9dc776fcc8ap-3, carg1);
    tmp25 = u * 0x1.f83a4d293427fp-57;
    tmp26 = tmp24 + tmp25;
    tmp27 = tmp23 + tmp26;
    tmp28 = -0x1.2779b1e27f67cp-3 + tmp27;
    tmp29 = tmp28 - tmp27;
    tmp30 = -0x1.2779b1e27f67cp-3 - tmp29;
    tmp31 = tmp28 - tmp29;
    tmp32 = tmp27 - tmp31;
    tmp33 = tmp30 + tmp32;
    tmp34 = tmp27 - tmp23;
    tmp35 = tmp26 - tmp34;
    tmp36 = 0x1.b02da63a1ad44p-58 + tmp35;
    tmp37 = tmp33 + tmp36;
    tmp38 = tmp28 + tmp37;
    tmp39 = u * tmp38;
    carg2 =  - tmp39;
    tmp40 = fma(u, tmp38, carg2);
    tmp41 = tmp38 - tmp28;
    tmp42 = tmp37 - tmp41;
    tmp43 = u * tmp42;
    tmp44 = tmp40 + tmp43;
    tmp45 = tmp39 + tmp44;
    tmp46 = 0x1.484b13d31a77p-3 + tmp45;
    tmp47 = tmp46 - tmp45;
    tmp48 = 0x1.484b13d31a77p-3 - tmp47;
    tmp49 = tmp46 - tmp47;
    tmp50 = tmp45 - tmp49;
    tmp51 = tmp48 + tmp50;
    tmp52 = tmp45 - tmp39;
    tmp53 = tmp44 - tmp52;
    tmp54 = -0x1.9590c0ccdcc61p-57 + tmp53;
    tmp55 = tmp51 + tmp54;
    tmp56 = tmp46 + tmp55;
    tmp57 = u * tmp56;
    carg3 =  - tmp57;
    tmp58 = fma(u, tmp56, carg3);
    tmp59 = tmp56 - tmp46;
    tmp60 = tmp55 - tmp59;
    tmp61 = u * tmp60;
    tmp62 = tmp58 + tmp61;
    tmp63 = tmp57 + tmp62;
    tmp64 = -0x1.7154764f68fd7p-3 + tmp63;
    tmp65 = tmp64 - tmp63;
    tmp66 = -0x1.7154764f68fd7p-3 - tmp65;
    tmp67 = tmp64 - tmp65;
    tmp68 = tmp63 - tmp67;
    tmp69 = tmp66 + tmp68;
    tmp70 = tmp63 - tmp57;
    tmp71 = tmp62 - tmp70;
    tmp72 = -0x1.3023adeab24b7p-57 + tmp71;
    tmp73 = tmp69 + tmp72;
    tmp74 = tmp64 + tmp73;
    tmp75 = u * tmp74;
    carg4 =  - tmp75;
    tmp76 = fma(u, tmp74, carg4);
    tmp77 = tmp74 - tmp64;
    tmp78 = tmp73 - tmp77;
    tmp79 = u * tmp78;
    tmp80 = tmp76 + tmp79;
    tmp81 = tmp75 + tmp80;
    tmp82 = 0x1.a61762a7adf0dp-3 + tmp81;
    tmp83 = tmp82 - tmp81;
    tmp84 = 0x1.a61762a7adf0dp-3 - tmp83;
    tmp85 = tmp82 - tmp83;
    tmp86 = tmp81 - tmp85;
    tmp87 = tmp84 + tmp86;
    tmp88 = tmp81 - tmp75;
    tmp89 = tmp80 - tmp88;
    tmp90 = -0x1.63db6cf18c0d4p-57 + tmp89;
    tmp91 = tmp87 + tmp90;
    tmp92 = tmp82 + tmp91;
    tmp93 = u * tmp92;
    carg5 =  - tmp93;
    tmp94 = fma(u, tmp92, carg5);
    tmp95 = tmp92 - tmp82;
    tmp96 = tmp91 - tmp95;
    tmp97 = u * tmp96;
    tmp98 = tmp94 + tmp97;
    tmp99 = tmp93 + tmp98;
    tmp100 = -0x1.ec709dc3a0419p-3 + tmp99;
    tmp101 = tmp100 - tmp99;
    tmp102 = -0x1.ec709dc3a0419p-3 - tmp101;
    tmp103 = tmp100 - tmp101;
    tmp104 = tmp99 - tmp103;
    tmp105 = tmp102 + tmp104;
    tmp106 = tmp99 - tmp93;
    tmp107 = tmp98 - tmp106;
    tmp108 = 0x1.67996ada057c2p-57 + tmp107;
    tmp109 = tmp105 + tmp108;
    tmp110 = tmp100 + tmp109;
    tmp111 = u * tmp110;
    carg6 =  - tmp111;
    tmp112 = fma(u, tmp110, carg6);
    tmp113 = tmp110 - tmp100;
    tmp114 = tmp109 - tmp113;
    tmp115 = u * tmp114;
    tmp116 = tmp112 + tmp115;
    tmp117 = tmp111 + tmp116;
    tmp118 = 0x1.2776c50ef9bfep-2 + tmp117;
    tmp119 = tmp118 - tmp117;
    tmp120 = 0x1.2776c50ef9bfep-2 - tmp119;
    tmp121 = tmp118 - tmp119;
    tmp122 = tmp117 - tmp121;
    tmp123 = tmp120 + tmp122;
    tmp124 = tmp117 - tmp111;
    tmp125 = tmp116 - tmp124;
    tmp126 = 0x1.e48f96420b1fcp-56 + tmp125;
    tmp127 = tmp123 + tmp126;
    tmp128 = tmp118 + tmp127;
    tmp129 = u * tmp128;
    carg7 =  - tmp129;
    tmp130 = fma(u, tmp128, carg7);
    tmp131 = tmp128 - tmp118;
    tmp132 = tmp127 - tmp131;
    tmp133 = u * tmp132;
    tmp134 = tmp130 + tmp133;
    tmp135 = tmp129 + tmp134;
    tmp136 = -0x1.71547652b82fep-2 + tmp135;
    tmp137 = tmp136 - tmp135;
    tmp138 = -0x1.71547652b82fep-2 - tmp137;
    tmp139 = tmp136 - tmp137;
    tmp140 = tmp135 - tmp139;
    tmp141 = tmp138 + tmp140;
    tmp142 = tmp135 - tmp129;
    tmp143 = tmp134 - tmp142;
    tmp144 = -0x1.774c4dfbea4ap-58 + tmp143;
    tmp145 = tmp141 + tmp144;
    tmp146 = tmp136 + tmp145;
    tmp147 = u * tmp146;
    carg8 =  - tmp147;
    tmp148 = fma(u, tmp146, carg8);
    tmp149 = tmp146 - tmp136;
    tmp150 = tmp145 - tmp149;
    tmp151 = u * tmp150;
    tmp152 = tmp148 + tmp151;
    tmp153 = tmp147 + tmp152;
    tmp154 = 0x1.ec709dc3a03fdp-2 + tmp153;
    tmp155 = tmp154 - tmp153;
    tmp156 = 0x1.ec709dc3a03fdp-2 - tmp155;
    tmp157 = tmp154 - tmp155;
    tmp158 = tmp153 - tmp157;
    tmp159 = tmp156 + tmp158;
    tmp160 = tmp153 - tmp147;
    tmp161 = tmp152 - tmp160;
    tmp162 = 0x1.d27f0559c0f02p-56 + tmp161;
    tmp163 = tmp159 + tmp162;
    tmp164 = tmp154 + tmp163;
    tmp165 = u * tmp164;
    carg9 =  - tmp165;
    tmp166 = fma(u, tmp164, carg9);
    tmp167 = tmp164 - tmp154;
    tmp168 = tmp163 - tmp167;
    tmp169 = u * tmp168;
    tmp170 = tmp166 + tmp169;
    tmp171 = tmp165 + tmp170;
    tmp172 = -0x1.71547652b82fep-1 + tmp171;
    tmp173 = tmp172 - tmp171;
    tmp174 = -0x1.71547652b82fep-1 - tmp173;
    tmp175 = tmp172 - tmp173;
    tmp176 = tmp171 - tmp175;
    tmp177 = tmp174 + tmp176;
    tmp178 = tmp171 - tmp165;
    tmp179 = tmp170 - tmp178;
    tmp180 = -0x1.777d0fff670fcp-57 + tmp179;
    tmp181 = tmp177 + tmp180;
    tmp182 = tmp172 + tmp181;
    tmp183 = u * tmp182;
    carg10 =  - tmp183;
    tmp184 = fma(u, tmp182, carg10);
    tmp185 = tmp182 - tmp172;
    tmp186 = tmp181 - tmp185;
    tmp187 = u * tmp186;
    tmp188 = tmp184 + tmp187;
    tmp189 = tmp183 + tmp188;
    tmp190 = 0x1.71547652b82fep0 + tmp189;
    tmp191 = tmp190 - tmp189;
    tmp192 = 0x1.71547652b82fep0 - tmp191;
    tmp193 = tmp190 - tmp191;
    tmp194 = tmp189 - tmp193;
    tmp195 = tmp192 + tmp194;
    tmp196 = tmp189 - tmp183;
    tmp197 = tmp188 - tmp196;
    tmp198 = 0x1.777d0ffda0d2p-56 + tmp197;
    tmp199 = tmp195 + tmp198;
    tmp200 = tmp190 + tmp199;
    tmp201 = u * tmp200;
    carg11 =  - tmp201;
    tmp202 = fma(u, tmp200, carg11);
    tmp203 = tmp200 - tmp190;
    tmp204 = tmp199 - tmp203;
    tmp205 = u * tmp204;
    tmp206 = tmp202 + tmp205;
    log1pu_poly_hi = tmp201 + tmp206;
    tmp207 = fp_exponent + log1pu_poly_hi;
    tmp208 = log1pu_poly_hi - tmp201;
    log1pu_poly_lo = tmp206 - tmp208;
    tmp209 = tmp207 - log1pu_poly_hi;
    tmp210 = fp_exponent - tmp209;
    tmp211 = tmp207 - tmp209;
    tmp212 = log1pu_poly_hi - tmp211;
    tmp213 = tmp210 + tmp212;
    tmp214 = tmp213 + log1pu_poly_lo;
    tmp215 = tmp207 + tmp214;
    tmp216 = tmp215 + tbl_hi;
    tmp217 = tmp216 - tbl_hi;
    tmp218 = tmp215 - tmp217;
    tmp219 = tmp216 - tmp217;
    tmp220 = tbl_hi - tmp219;
    tmp221 = tmp218 + tmp220;
    table_index_lo = table_index_hi + UINT32_C(1);
    tbl_lo = ml_log1p_table[table_index_lo];
    tmp222 = tmp215 - tmp207;
    tmp223 = tmp214 - tmp222;
    tmp224 = tmp223 + tbl_lo;
    tmp225 = tmp221 + tmp224;
    logx_hi = tmp216 + tmp225;
    return logx_hi;
}
